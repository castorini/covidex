...
const HomeText = () => {
  return (
    <div>
      <Paragraph>
        Covidex represents an effort to build natural language processing and
      ...
      <Paragraph>
        We hope that these tools can help researchers generate new insights in
        support of the fight against the disease.
      </Paragraph>
      <Paragraph>Presently, our efforts include:</Paragraph>
      <ul>
        <ListItem>
          The above search interface, which integrates neural ranking components
          in a multi-stage search reranking pipeline using the&nbsp;
          <Link
        ...
        <ListItem>
          ...
          <Link
            href="https://covidex.io/"
            target="_blank"
            rel="noopener noreferrer"
          >
            covidex.io
          </Link>
          , which provides faceted browsing capabilities on the CORD-19 dataset
          (title and abstracts only). Under the covers, the interface is powered
          by&nbsp;
          <Link
            href="https://projectblacklight.org/"
            target="_blank"
            rel="noopener noreferrer"
          >
            Blacklight
        ...
        <ListItem>
          Backend components (code as well as pre-built indexes) for directly
          searching and manipulating the collection via&nbsp;
          <Link
            href="http://pyserini.io/"
            target="_blank"
            rel="noopener noreferrer"
          >
            Pyserini
          </Link>
          &nbsp;(Python bindings for Anserini), along with sample integration of
          search with&nbsp;
          <Link
          ...
          . &nbsp;Example Python notebooks and other resources for getting
