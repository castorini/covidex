  ...
  return (
    <HomeTextWrapper>
      <Paragraph>
        ...
        (data release of June 12, 2020), which currently contains over 140,000 scholarly articles,
        including over 70,000 with full text, about COVID-19 and coronavirus-related research, drawn
